# -*- coding: utf-8 -*-
"""Usecase 1 - Prediction Model (1).py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14IIdtusrs_klj7uFcpEvgi3Og8KlKSLs
...
df1.rename(columns={
    'Balance Q2': 'Balance Q1',
    'Balance Q3': 'Balance Q2',
    'Balance Q4': 'Balance Q3',
    'Balance Q5': 'Balance Q4',
    'NumOfProducts Q2': 'NumOfProducts Q1',
    'NumOfProducts Q3': 'NumOfProducts Q2',
    'NumOfProducts Q4': 'NumOfProducts Q3',
    'NumOfProducts Q5': 'NumOfProducts Q4',
    'ActiveMember Q2': 'ActiveMember Q1',
    'ActiveMember Q3': 'ActiveMember Q2',
    'ActiveMember Q4': 'ActiveMember Q3',
    'ActiveMember Q5': 'ActiveMember Q4',
    'HasCrCard Q2': 'HasCrCard Q1',
    'HasCrCard Q3': 'HasCrCard Q2',
    'HasCrCard Q4': 'HasCrCard Q3',
    'HasCrCard Q5':'HasCrCard Q4'
}, inplace=True)
df1.head()
...
data1 = pd.DataFrame(
    df_all.groupby("City")["Customer ID"]
    .count()
...
data3 = pd.DataFrame(
    df_val.groupby("Age")["Customer ID"]
    .count()
...
data4 = pd.DataFrame(
    df_val[df_val["Unpaid Tagging"] == 1]
    .groupby("Age")["Customer ID"]
    .count()
    .reset_index(name="Distribution by Age")
)
data4.sort_values(
...
data5 = pd.DataFrame(
    df_checkbalance.groupby("Unpaid Tagging")["Total Balance"]
    .mean()
...
data6 = pd.DataFrame(
    df_checkbalance.groupby("Unpaid Tagging")["Avg Balance"]
    .mean()
    .reset_index(name="AVG Quarter Balance")
    .round(1)
)
data6
...
data7 = pd.DataFrame(
    df_checkbalance.groupby("Unpaid Tagging")["Avg Product"]
    .mean()
    .reset_index(name="AVG Num of Product")
    .round(2)
)
data7
...
df1['Vintage_CR(Month)'] = df1.apply(assign_cr1, axis = 1)

df1.head()

"""Eksperimen 2"""

df2['Vintage_CR(Month)'] = df2.apply(assign_cr1, axis = 1)
...
df2_val['Mean Balance'] = (df1_val['Balance Q4']+df1_val['Balance Q5'])/2
...
df1_val['Vintage_CR(Month)'] = df1_val.apply(assign_cr2, axis = 1)
df2_val['Vintage_CR(Month)'] = df2_val.apply(assign_cr2, axis = 1)
...
GB_Grid = GridSearchCV(GradientBoostingClassifier(), gbparameter, cv=5, refit='recall', verbose=0, n_jobs=-1, scoring=score)
...
GB_Grid2 = GridSearchCV(GradientBoostingClassifier(), gbparameter, cv=5,refit='recall', verbose=0, n_jobs=-1, scoring=score)
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y1_test, y1_test_pred))
f1_scores.append(f1_score(y1_test, y1_test_pred))
precision_scores.append(precision_score(y1_test, y1_test_pred))
recall_scores.append(recall_score(y1_test, y1_test_pred))
...
ConfusionMatrixDisplay.from_predictions(y1_test, y1_test_pred, cmap="Blues")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y1_val, y1_pred_val))
f1_scores.append(f1_score(y1_val, y1_pred_val))
precision_scores.append(precision_score(y1_val, y1_pred_val))
recall_scores.append(recall_score(y1_val, y1_pred_val))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y1_val, y1_pred_val, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y1_val, y1_pred_val, cmap="Blues")
plt.show()
...
y2_pred_test = grid.predict(X2_test)
accuracy_scores=[]
f1_scores=[]
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y2_test, y2_pred_test))
f1_scores.append(f1_score(y2_test, y2_pred_test))
precision_scores.append(precision_score(y2_test, y2_pred_test))
recall_scores.append(recall_score(y2_test, y2_pred_test))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y2_test, y2_pred_test, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y2_test, y2_pred_test, cmap="Blues")
plt.show()
...
y2_test_val = grid.predict(X2_val)
accuracy_scores=[]
f1_scores=[]
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score( y2_val,y2_test_val))
f1_scores.append(f1_score( y2_val,y2_test_val))
precision_scores.append(precision_score( y2_val,y2_test_val))
recall_scores.append(recall_score( y2_val,y2_test_val))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report( y2_val,y2_test_val, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions( y2_val,y2_test_val, cmap="Blues")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y1_test, y11_pred))
f1_scores.append(f1_score(y1_test, y11_pred))
precision_scores.append(precision_score(y1_test, y11_pred))
recall_scores.append(recall_score(y1_test, y11_pred))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y1_test, y11_pred, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y1_test, y11_pred, cmap="Reds")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y1_val, y11_pred_val))
f1_scores.append(f1_score(y1_val, y11_pred_val))
precision_scores.append(precision_score(y1_val, y11_pred_val))
recall_scores.append(recall_score(y1_val, y11_pred_val))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y1_val, y11_pred_val, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y1_val, y11_pred_val, cmap="Reds")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y2_test, y22_pred))
f1_scores.append(f1_score(y2_test, y22_pred))
precision_scores.append(precision_score(y2_test, y22_pred))
recall_scores.append(recall_score(y2_test, y22_pred))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y2_test, y22_pred, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y2_test, y22_pred, cmap="Reds")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y2_val, y22_pred_val))
f1_scores.append(f1_score(y2_val, y22_pred_val))
precision_scores.append(precision_score(y2_val, y22_pred_val))
recall_scores.append(recall_score(y2_val, y22_pred_val))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y2_val, y22_pred_val, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y2_val, y22_pred_val, cmap="Reds")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y1_test, y12_pred))
f1_scores.append(f1_score(y1_test, y12_pred))
precision_scores.append(precision_score(y1_test, y12_pred))
recall_scores.append(recall_score(y1_test, y12_pred))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y1_test, y12_pred, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y1_test, y12_pred, cmap="Reds")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y1_val, y12_pred_val))
f1_scores.append(f1_score(y1_val, y12_pred_val))
precision_scores.append(precision_score(y1_val, y12_pred_val))
recall_scores.append(recall_score(y1_val, y12_pred_val))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y1_val, y12_pred_val, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y1_val, y12_pred_val, cmap="Reds")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y2_test, y21_pred))
f1_scores.append(f1_score(y2_test, y21_pred))
precision_scores.append(precision_score(y2_test, y21_pred))
recall_scores.append(recall_score(y2_test, y21_pred))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y2_test, y21_pred, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y2_test, y21_pred, cmap="Reds")
plt.show()
...
precision_scores=[]
recall_scores=[]
accuracy_scores.append(accuracy_score(y2_val, y21_pred_val))
f1_scores.append(f1_score(y2_val, y21_pred_val))
precision_scores.append(precision_score(y2_val, y21_pred_val))
recall_scores.append(recall_score(y2_val, y21_pred_val))
...
print("Classifiaction Report")
print("-------------------------------")
print(classification_report(y2_val, y21_pred_val, digits=4))
print("Confusion_Matrix")
ConfusionMatrixDisplay.from_predictions(y2_val, y21_pred_val, cmap="Reds")
plt.show()
